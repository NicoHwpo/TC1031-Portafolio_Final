#ifndef __MAXHEAP1_H_
#define __MAXHEAP1_H_
...
template <class T>
MaxHeap1<T>::MaxHeap1(int capacity)
{
...
template <class T>
int MaxHeap1<T>::getCapacity()
{
    return maxSize;
}

template <class T>
void MaxHeap1<T>::printMaxHeap()
{
...
template <class T>
int MaxHeap1<T>::parent(int i)
{
    return (i - 1) / 2;
}

template <class T>
int MaxHeap1<T>::left(int i)
{
    return (2 * i + 1);
}

template <class T>
int MaxHeap1<T>::right(int i)
{
    return (2 * i + 2);
}

template <class T>
void MaxHeap1<T>::push(T key)
{
    if (size == maxSize)
    {
...
template <class T>
bool MaxHeap1<T>::isEmpty()
{
    return (size <= 0);
}

 template <class T>
 int MaxHeap1<T>::getSize() {
   return size;          //size contiene el tamaño actual del heap; solo se imprime "size"
 }


template <class T>
void MaxHeap1<T>::cuentaRepes(std::vector<int> u)
{
...
template <class T>
void MaxHeap1<T>::remove(std::vector<int> &v)
{
...
template <class T>
std::vector<std::string> MaxHeap1<T>::CincoIpsMasAcces()
{
    int in, a = 0;
...
template <class T>
std::vector<std::string> MaxHeap1<T>::IpMasAcces()
{
    int in, a = 0;
...
template <class T>
void MaxHeap1<T>::printOutIpsMasAcces() {
    std::fstream bitHeap;
    std::vector<std::string> f;
    f = IpMasAcces();
    
    bitHeap.open("ips_con_mayor_acceso.txt",std::ios::out);
    if (bitHeap.is_open()) {
        for(int i=0; i<f.size(); i++) {
            bitHeap<<f[i]<<std::endl;
        }
    }
    else {
        bitHeap.close();
...
template <class T>
int MaxHeap1<T>::getIndex(std::vector<int> v, int K)
{
...
template <class T>
std::vector<int> MaxHeap1<T>::findItems(std::vector<T> const &v, int target)
{
...
template <class T>
std::vector<int> MaxHeap1<T>::decToBinaryToIp(int a)
{
    std::vector<int> g;
    short bin[32];
    for (int i = 0; i < 32; i++)
